...
open class PacketTunnelNetworkExtension: MoonbounceNetworkExtensionUniverse
{
    override public func startTunnel(options: [String: NSObject]?) -> Error?
    {
        ...
        do
        {
            ...
            configuration = try self.getTunnelConfiguration()
        ...
        guard let serverAddress: String = configuration.serverAddress else
        {
            ...
            os_log("MoonbounceLibrary: PacketTunnelNetworkExtension: Unable to get the server address.")
...
//        }
        ...
        guard let tunnelProviderConfiguration = configuration as? NETunnelProviderProtocol else
        {
            os_log("MoonbounceLibrary: Failed to get the configuration as? NETunnelProviderProtocol.")
...
//        let port = shadowConfig.port
    ...
    public func getTunnelConfiguration() throws -> NEVPNProtocol
    {
